...
import { VoteGatingSnapshot, VotingRoundMetadata } from '@algorandfoundation/xgov-core'
import { VotingRoundGlobalState, fetchAddressesThatVoted } from '@algorandfoundation/xgov-core'
